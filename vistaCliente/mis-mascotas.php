      ...
      <div class="col-md-6">
        ...
        if ($result->num_rows > 0) {
          ...
          while ($row = $result->fetch_assoc()) {
            ...
            if (!empty($row['foto'])) {
              echo "<img src='" . htmlspecialchars($row['foto']) . "' alt='" . htmlspecialchars($row['nombre']) . "' class='img-fluid' style='max-width: 100px;'>";
            }
            echo "<p>Raza: " . htmlspecialchars($row['raza'] ?? 'N/A') . "</p>";
            echo "<a href='../shared/detalle-mascota.php?idMascota=" . $row['id'] . "' class='btn btn-info'>Ver</a>";
            echo "</li>";
          }
          echo "</ul>";
        } else {
