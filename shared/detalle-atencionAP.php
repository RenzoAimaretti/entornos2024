        ...
        <div class="Card text-center" style="width:50rem;">
            ...
            <div class="card-body">
                ...
                <div class="mb-4">
                    ...
                    <p class="card-text text-secondary"><?php echo date('d/m/Y H:i', strtotime($atencion['fecha'])); ?>
                    </p>
                </div>
                <div class="mb-4">
