...
<body>
  ...
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="iniciar-sesion.html">Iniciar sesión</a></li>
          ...
          <div class="card-body">
            <form action="registro.php" method="post">
              ...
              <div class="form-group">
                ...
                <input type="password" class="form-control" id="password" name="password" required oninput="verificarPassword()">
              ...
              <div class="form-group">
                ...
                <small id="error-contraseña" class="text-danger" style="display: none;">Las contraseñas no coinciden</small>
              </div>
