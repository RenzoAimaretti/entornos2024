...
<head>
    ...
    <title>Detalle Cliente - Veterinaria San Antón</title>
    ...
    <div class="container mt-5 mb-5">
                ...
                <div class="col-lg-4 mb-4">
                    <div class="card shadow-sm border-0 profile-card h-100">
                        <div class="card-body text-center p-4">
                            ...
                            <p class="text-muted small mb-4">Cliente Registrado</p>

                            <ul class="list-group list-group-flush text-left mb-4">
                                <li class="list-group-item px-0 border-0 py-1">
                                    <i class="fas fa-envelope text-teal mr-2" style="width:20px"></i>
                                    <?php echo htmlspecialchars($cliente['email']); ?>
                                </li>
                                <li class="list-group-item px-0 border-0 py-1">
                                    <i class="fas fa-phone text-teal mr-2" style="width:20px"></i>
                                    <?php echo htmlspecialchars($cliente['telefono'] ?? 'N/A'); ?>
                                </li>
                                <li class="list-group-item px-0 border-0 py-1">
                                    <i class="fas fa-map-marker-alt text-teal mr-2" style="width:20px"></i>
                                    <?php echo htmlspecialchars($cliente['direccion'] ?? 'N/A'); ?>
                                </li>
                            </ul>
                    ...
                    <div class="card shadow-sm border-0 mb-4">
                        <div
                            ...
                            <h5 class="font-weight-bold text-secondary mb-0">
                                <i class="fas fa-paw mr-2 text-teal"></i> Mascotas Asociadas
                            </h5>
                            <a href="agregar-mascota.php?id=<?php echo $id ?>"
                                class="btn btn-sm btn-success rounded-pill font-weight-bold shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <?php if ($resultMascotas && $resultMascotas->num_rows > 0): ?>
                                <div class="list-group list-group-flush">
                                    <?php while ($mascota = $resultMascotas->fetch_assoc()): ?>
                                        <div class="list-group-item mascota-item rounded mb-2 p-3">
                                            <div class="d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="text-right">
                                                    <small class="d-block text-muted mb-1">
                                                        Nac: <?php echo date('d/m/Y', strtotime($mascota['fecha_nac'])); ?>
                                                    </small>
                            ...
                            <?php else: ?>
                                <div class="text-center py-5">
                                    ...
                                    <a href="agregar-mascota.php?id=<?php echo $id ?>" class="btn btn-outline-success btn-sm">
                        ...
                        <form method="POST" action="../shared/editar-cliente.php">
                            <div class="modal-body p-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <small class="form-text text-muted">El nombre se edita desde la cuenta de
                                        usuario.</small>
                                </div>
        ...
        <?php else: ?>
            <div class="alert alert-danger text-center shadow-sm">
                ...
                <p>El ID solicitado no existe o ha sido eliminado.</p>
                <hr>
                <a href="gestionar-clientes.php" class="btn btn-outline-danger">Volver al listado</a>
            </div>
        <?php endif; ?>
